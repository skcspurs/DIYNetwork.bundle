...
def MainMenu():
    ...
    oc.add(DirectoryObject(key = Callback(Alphabet, title='All DIY Shows'), title='All DIY Shows'))

    return oc

####################################################################################################
# This function produces a list of shows from the DIY full episodes page
...
####################################################################################################
# This function produces a list of all DIY Shows based on letter chosen in Alphabet function
